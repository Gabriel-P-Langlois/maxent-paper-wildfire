...
% This script fits an \ell_{\inf}-regularized Maxent model
...
lambda_est = norm(Ed - mat_annual'*pprior,1);
...
if(use_npdhg)
    ...
    for i=2:1:l_max
        ...
        [sol_w(:,i),sol_p(:,i),num_iter_tot_reg] = ... 
            ...
            lambda(i),mat_annual,tau,sigma,theta,Ed,...
            max_iter,tol); 
...
if(use_fista)
    ...
    for i=2:1:l_max
        ...
        [sol_w(:,i),sol_p(:,i),num_iter_tot_reg] = ... 
            ...
            lambda(i),mat_annual,tau,mu,q,Ed,...
            max_iter,tol);   
...
if(save_results)
    ...
    save(strjoin(["data/generated_data/reg_path_linf,min_path=",...
    ...
    save(strjoin(["data/generated_data/p_sol_linf,min_path=",...
        num2str(reg_path(end)),...
        '.mat'],''),'reshaped_sol_p')
    
    % Save the coefficients w characterizing the exponential family
    save(strjoin(["data/generated_data/w_sol_linf=,min_path=",...
        num2str(reg_path(end)),...
        '.mat'],''),'sol_w')
    ...
    save(strjoin(["data/generated_data/threshold_vals_linf=,min_path=",...
        num2str(reg_path(end)),...
