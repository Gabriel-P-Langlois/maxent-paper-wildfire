function [amat_annual,pprior,pempirical,Ed,n0,n1,name_features,idx_features] = process_wildfire_data

% Extract the full feature matrix
...
% Those are entries 4, 6, 9, and 35.
amat(:,[4,6,9,35]) = [];
